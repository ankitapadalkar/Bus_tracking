    <div id="header">
      <h1><a href="dashboard.php">Bus Tracking Admin</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <div id="sidebar">
      ...
      <ul>
        ...
        <li class="submenu">
          <a href="#"
            ><i class="icon icon-th-list"></i> <span>Master</span>
            <span class="label label-important">3</span></a
          >
          <ul>
            <li><a href="bus_list.php">Bus Master</a></li>
            <li><a href="location_list.php">Location Master</a></li>
            <li><a href="busassign_list.php">Bus Assign Master</a></li>
          </ul>
        </li>
        <!-- <li>
          <a href="buttons.html"
        ...
        <li class="submenu">
          <a href="#"
            ><i class="icon icon-file"></i> <span>Transaction</span>
            <span class="label label-important">1</span></a
          >
          <ul>
            <li><a href="bus_tracking_admin_list.php">Bus Tracking Entry</a></li>
