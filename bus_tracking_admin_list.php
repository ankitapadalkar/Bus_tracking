                ...
                <table class="table table-bordered data-table">
                  ...
                  ORDER BY trackingid DESC";
                    ...
                    <tr class="gradeX">
                      ...
                      <td><a class="btn btn-primary btn-mini" target="_blank" href="http://maps.google.com/?q=<?php echo $row['latitude'] ?>,<?php echo $row['longitude'] ?>">View Start Location</a></td>
                      <td><a class="btn btn-primary btn-mini" target="_blank" href="http://maps.google.com/?q=<?php echo $row['latitude_end'] ?>,<?php echo $row['longitude_end'] ?>">View End Location</a></td>
