  ...
  <body>
    ...
    <div id="content">
      <div id="content-header">
       ...
       &nbsp;&nbsp; &nbsp;&nbsp; <a class="btn btn-primary btn-mini" href="busassignmaster.php">Add New Bus Record</a>
      </div>
            ...
            <div class="widget-box">
              ...
              <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                  ...
                  <?php $sql="select busmaster.busname,bus_assign_master.assignid,users.username from bus_assign_master
                  
                   inner join busmaster on busmaster.busId=bus_assign_master.busId
                   inner join users on users.userid=bus_assign_master.userid
                  ...
                  ?>
                    <tr class="gradeX">
                      ...
                      <td><a class="btn btn-primary btn-mini" href="busassignmaster.php?id=<?php echo $row['assignid']; ?>">Edit</a></td>
                      <td class="center"> <a class="btn btn-danger btn-mini" href="busassign_list.php?id=<?php echo $row['assignid']; ?>&flag=1">Delete</a></td>
                    </tr>
                    <?php } ?>   
                  </tbody>
                </table>
